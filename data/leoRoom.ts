...
export const interactiveObjects: RoomObject[] = [
  ...
  { id: "window", geometry: "window", position: [5.95, 3.2, 1.9], rotation: [0, -Math.PI / 2, 0], title: { cn: "我的世界", en: "Leo’s World" }, kicker: { cn: "窗户", en: "Window" }, description: { cn: "向外看，也看看我的世界。", en: "Look outward, and into Leo’s World." }, camera: { position: [4.45, 3.3, 3.7], target: [5.8, 3.2, 1.85] } },

...
export function RoomHover({children}:{children:ReactNode}){
 ...
 return <group ref={root} name="room-hover-response" onPointerOver={e=>{hover.current=e.nativeEvent.pointerType!=="touch";}} onPointerOut={()=>{hover.current=false;}}>{children}</group>;
}
